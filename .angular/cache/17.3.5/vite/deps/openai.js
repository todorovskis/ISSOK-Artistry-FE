  ...
  if (!params || !hasAutoParseableInput(params)) {
    return __spreadProps(__spreadValues({}, completion), {
      choices: completion.choices.map((choice) => __spreadProps(__spreadValues({}, choice), {
        message: __spreadProps(__spreadValues({}, choice.message), { parsed: null, tool_calls: choice.message.tool_calls ?? [] })
      }))
    });
  }
...
var Completions2 = class extends APIResource {
  parse(body, options) {
    return __async(this, null, function* () {
      ...
      const completion = yield this._client.chat.completions.create(body, __spreadProps(__spreadValues({}, options), {
